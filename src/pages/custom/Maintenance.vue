<template>
  <!-- <div class="container p-2">
    <div class="box p-2">
      ...
      <h1 class="mb-3">MoreBitcoin - Under maintenance</h1>
      <p>
        Hi there, recently; there's been a couple of complaints regarding
        withdrawals. Attackers are intercepting and submiting wrong withdrawal
        accounts on behalf of our customers.
      </p>
      <p class="mt-4">
        We asure you that our techincal team is working hard to resolve and
        settle the disputes as well as restoring the withdrawal service. In this
        regard, we place a temporary stop for customers to initiate withdrawals.
        All investments made with MoreBitcoin are safe and withdrawals would be
        enabled soon.
      </p>
