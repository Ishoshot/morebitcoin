<template>
  <div class="container p-2">
    <div class="box p-2">
      ...
      <h1 class="mb-3">
        MoreBitcoin -
        <span class="text-danger font-weight-bold"> Under Attack</span>
      </h1>
      <p>
        Dear esteemed investor, please we are in a situation at the moment of
        the maintenance of the platform. We are currently under attack and we
        are working hard to get back online as soon as possible.
        <br />
        It saddens us that you have to wait for a while. However, to put it out
        there and inform you, the <span>Black Cat</span> are currently asking
        for a sum equivalent to the value of
        <span class="text-primary">USD 89 billion</span> in Bitcoin. <br />
        Our team is working to finalize and put some actions in plca eot ensure
        we get our platform back online as soon as possible.
      </p>
      <p class="mt-4">
        We asure you that our techincal team is working hard to keep track of
        the investments and settle the disputes as well as restoring the
        platform. In this regard, we place a temporary stop for customers to
        engage the platform.
      </p>
